...
/// NTRU-HRSS-1373 key encapsulation (structured-lattice KEM).
///
...
/// N = 1373. Unlike the fixed-weight HPS variants, HRSS samples its secrets
/// without a fixed Hamming weight. This is the higher-security NTRU-HRSS
/// parameter set, with a wider security margin and larger keys than
/// NTRU-HRSS-701.
///
/// ```swift
/// // Alice generates a key pair
/// let alice = try NTRUHRSS1373.PrivateKey()
///
/// // Bob gets Alice's public key and creates a shared secret
/// let pub = try NTRUHRSS1373.PublicKey(rawRepresentation: alicePublicKeyData)
...
/// let loaded = try NTRUHRSS1373.PrivateKey(
///     rawRepresentation: saved,
///     publicKeyRepresentation: alice.publicKey.rawRepresentation
/// )
/// ```
public enum NTRUHRSS1373: Sendable {
    static let algorithmName = "NTRU-HRSS-1373"

    /// A NTRUHRSS1373 private (decapsulation) key.
    public struct PrivateKey: Sendable {
        ...
        public init() throws {
            let kp = try kemGenerateKeyPair(algorithm: NTRUHRSS1373.algorithmName)
        ...
        public init(rawRepresentation: Data, publicKeyRepresentation: Data) throws {
            let lengths = try kemExpectedKeyLengths(algorithm: NTRUHRSS1373.algorithmName)
        ...
        public func decryptSharedSecret(_ ciphertext: Data) throws -> SharedSecret {
            let ss = try kemDecapsulate(algorithm: NTRUHRSS1373.algorithmName, ciphertext: ciphertext, secretKey: rawRepresentation)
            return SharedSecret(rawRepresentation: ss)
        }
    }

    /// A NTRUHRSS1373 public (encapsulation) key.
    public struct PublicKey: Sendable {
        ...
        public func generateSharedSecret() throws -> SharedSecretResult {
            let result = try kemEncapsulate(algorithm: NTRUHRSS1373.algorithmName, publicKey: rawRepresentation)
