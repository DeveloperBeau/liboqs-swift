...
/// SNOVA-60-10-4 digital signatures (multivariate UOV-family scheme, compact keys).
///
...
/// This `60-10-4` set is the largest SNOVA parameter choice, targeting the
...
/// let signer = try SNOVA60_10_4.PrivateKey()
///
/// // Sign something
/// let sig = try signer.signature(for: messageData)
///
/// // Anyone with the public key can verify
/// let pub = try SNOVA60_10_4.PublicKey(rawRepresentation: signerPublicKeyData)
...
/// let loaded = try SNOVA60_10_4.PrivateKey(
///     rawRepresentation: saved,
///     publicKeyRepresentation: signer.publicKey.rawRepresentation
/// )
/// ```
public enum SNOVA60_10_4: Sendable {
    static let algorithmName = "SNOVA_60_10_4"

    /// A SNOVA-60-10-4 private (signing) key.
    public struct PrivateKey: Sendable {
        ...
        public init() throws {
            let kp = try sigGenerateKeyPair(algorithm: SNOVA60_10_4.algorithmName)
        ...
        public init(rawRepresentation: Data, publicKeyRepresentation: Data) throws {
            let lengths = try sigExpectedKeyLengths(algorithm: SNOVA60_10_4.algorithmName)
        ...
        public func signature(for data: Data) throws -> Data {
            try sigSign(algorithm: SNOVA60_10_4.algorithmName, message: data, secretKey: rawRepresentation)
        }
    }

    /// A SNOVA-60-10-4 public (verification) key.
    public struct PublicKey: Sendable {
        ...
        public func isValidSignature(_ signature: Data, for data: Data) throws -> Bool {
            try sigVerify(algorithm: SNOVA60_10_4.algorithmName, message: data, signature: signature, publicKey: rawRepresentation)
        }
    }
}
