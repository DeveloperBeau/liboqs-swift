...
/// SNOVA-49-11-3 digital signatures (multivariate UOV-family scheme, compact keys).
///
...
/// This `49-11-3` set uses a rank-3 layout at a higher security tier.
///
...
/// let signer = try SNOVA49_11_3.PrivateKey()
///
/// // Sign something
/// let sig = try signer.signature(for: messageData)
///
/// // Anyone with the public key can verify
/// let pub = try SNOVA49_11_3.PublicKey(rawRepresentation: signerPublicKeyData)
...
/// let loaded = try SNOVA49_11_3.PrivateKey(
///     rawRepresentation: saved,
///     publicKeyRepresentation: signer.publicKey.rawRepresentation
/// )
/// ```
public enum SNOVA49_11_3: Sendable {
    static let algorithmName = "SNOVA_49_11_3"

    /// A SNOVA-49-11-3 private (signing) key.
    public struct PrivateKey: Sendable {
        ...
        public init() throws {
            let kp = try sigGenerateKeyPair(algorithm: SNOVA49_11_3.algorithmName)
        ...
        public init(rawRepresentation: Data, publicKeyRepresentation: Data) throws {
            let lengths = try sigExpectedKeyLengths(algorithm: SNOVA49_11_3.algorithmName)
        ...
        public func signature(for data: Data) throws -> Data {
            try sigSign(algorithm: SNOVA49_11_3.algorithmName, message: data, secretKey: rawRepresentation)
        }
    }

    /// A SNOVA-49-11-3 public (verification) key.
    public struct PublicKey: Sendable {
        ...
        public func isValidSignature(_ signature: Data, for data: Data) throws -> Bool {
            try sigVerify(algorithm: SNOVA49_11_3.algorithmName, message: data, signature: signature, publicKey: rawRepresentation)
        }
    }
}
