...
/// SNOVA-37-8-4 digital signatures (multivariate UOV-family scheme, compact keys).
///
...
/// This `37-8-4` set enlarges the vinegar and oil counts for a higher
/// security margin than the entry-level variants.
///
...
/// let signer = try SNOVA37_8_4.PrivateKey()
///
/// // Sign something
/// let sig = try signer.signature(for: messageData)
///
/// // Anyone with the public key can verify
/// let pub = try SNOVA37_8_4.PublicKey(rawRepresentation: signerPublicKeyData)
...
/// let loaded = try SNOVA37_8_4.PrivateKey(
///     rawRepresentation: saved,
///     publicKeyRepresentation: signer.publicKey.rawRepresentation
/// )
/// ```
public enum SNOVA37_8_4: Sendable {
    static let algorithmName = "SNOVA_37_8_4"

    /// A SNOVA-37-8-4 private (signing) key.
    public struct PrivateKey: Sendable {
        ...
        public init() throws {
            let kp = try sigGenerateKeyPair(algorithm: SNOVA37_8_4.algorithmName)
        ...
        public init(rawRepresentation: Data, publicKeyRepresentation: Data) throws {
            let lengths = try sigExpectedKeyLengths(algorithm: SNOVA37_8_4.algorithmName)
        ...
        public func signature(for data: Data) throws -> Data {
            try sigSign(algorithm: SNOVA37_8_4.algorithmName, message: data, secretKey: rawRepresentation)
        }
    }

    /// A SNOVA-37-8-4 public (verification) key.
    public struct PublicKey: Sendable {
        ...
        public func isValidSignature(_ signature: Data, for data: Data) throws -> Bool {
            try sigVerify(algorithm: SNOVA37_8_4.algorithmName, message: data, signature: signature, publicKey: rawRepresentation)
        }
    }
}
